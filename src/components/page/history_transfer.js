...
// CHILD COMPONENTS
import HistoryTransferComponent from '../child_page/history_transfer_component'

// CSS
import styles from '../../style/page/history_transfer'
...
class History_Transfer extends Component {
  constructor(props) {
    super(props)
  ...
  componentWillMount() {
    ...
    let count = 1;
      ...
      AsyncStorage.getItem('key')
        .then(KEY => {
          user_id.child(KEY + '/' + 'history_transfer').once('value').then(data => {
...
export default History_Transfer;
